...
- **Typography:** Ensure captions (`figcaption`) are styled elegantly (e.g., small caps, muted foreground, maybe hidden until hover on desktop?). _Decision: Keep visible for usability, but style it._
