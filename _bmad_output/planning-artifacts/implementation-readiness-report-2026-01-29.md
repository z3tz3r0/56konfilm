...
- **Story 2.4 (Drag-and-Drop):** Mentions "May require a Sanity Plugin". This introduces a risk if no plugin exists.
  - _Remediation:_ Verify `sanity-plugin-media` or custom input capability during implementation planning.
- **Story 4.1 (SEO):** Mentions "Staging" domain.
  - _Remediation:_ Ensure Vercel Preview environments are correctly identified as "Staging" in `robots.txt` logic.
